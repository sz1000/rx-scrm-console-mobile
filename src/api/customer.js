...
export function cluecustomer_getClueCustomerByid(id) {
    //客户详情
    return request({
...
export function clueCustomerFollowUser_selectFollowMsgList(
    data,
    loading = false
) {
    // 当前客户跟进信息
...
export function clueCustomerFollowUser_message(id) {
    // 是否有新消息
    return request({
        url: BASE_CUSTOMER_SERVICE +
            '/clueCustomerFollowUser/user-message-receive?clueCustomerNo=' +
            id,
        method: 'get',
        headers: {
            noLoading: true,
...
export function clueCustomerFollowUser_message_notificatio(data) {
    // 添加消息通知（@）
    return request({
...
export function cluecustomer_addMessage(data) {
    // 写跟进
    return request({
...
export function group_getMobileCustomerGroupPage(data) {
    // 获取客户群列表
    return request({
...
export function group_getMobileGroupUserlist(id) {
    // 获取群群员列表
    return request({
...
export function clueCustomerFollowUser_addCommentInfo(data) {
    // 添加评论回复
    return request({
...
export function clueCustomerFollowUser_queryCommentInfoList(data) {
    // 查询评论回复
    return request({
...
export function clueCustomerFollowUser_giveTheThumbsUp(data) {
    // 点赞
    return request({
...
export function cluecustomeraccessory_getList(id) {
    // 获取附件列表
    return request({
        url: BASE_CUSTOMER_SERVICE +
            '/cluecustomeraccessory/getList?clueCustomerNo=' +
            id,
        method: 'get',
    })
}
export function cluecustomeraccessory_delupload(data) {
    // 删除附件
    return request({
...
export function clueCustomerFollowUser_applyFollowUser(id) {
    // 申请成为协助人
    return request({
        url: BASE_CUSTOMER_SERVICE +
            '/clueCustomerFollowUser/applyFollowUser?clueCustomerNo=' +
            id,
        method: 'get',
    })
}
export function clueCustomerFollowUser_approveHelperpplication(data) {
    // 协助人申请审批 1-同意2-拒绝
    return request({
...
export function clueCustomerFollowUser_addFollowUser(data) {
    // 新增协助人
    return request({
...
export function clueCustomerFollowUser_deleteFollowUsers(data) {
    // 删除协助人
    return request({
...
export function clueCustomerFollowUser_getFollowUserList(id) {
    // 获取协助人列表
    return request({
        url: BASE_CUSTOMER_SERVICE +
            '/clueCustomerFollowUser/getFollowUserList?cluecustomerno=' +
            id,
        method: 'get',
    })
}
...
export function cluecustomer_updPertag(data, no) {
    return request({
        url: BASE_CUSTOMER_SERVICE + '/cluecustomer/updPertag' + `/${no}`,
        method: 'post',
        data,
    })
}
