...
export function dataReport_getDataReportDaily(id, cid, type = 0) { //获取日报详情
    return request({
        url: BASE_CUSTOMER_SERCICE + '/dataReport/getDataReportDaily?userNo=' + id + '&corpId=' + cid + '&datatyp=' + type,
        method: 'post'
    })
}