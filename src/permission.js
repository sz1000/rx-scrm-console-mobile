...
var useList = ['/notice','/notice/daily','/notice/applyHelp','/home','/Interactive','/customerPortrait','/informationDetail', '/talkTool/verbalTrick', '/talkTool/contentMaterial']       //目前可使用页面路由
