    ...
    <div class="warp_box">
        ...
        <div class="form">
          <el-form ref="form" :rules="rules" :model="baseForm">
            ...
            <el-form-item label="任务名称 :" prop="taskName">
              <el-input v-model="baseForm.taskName" maxlength="10" placeholder="请输入任务名称" show-word-limit></el-input>
            </el-form-item>
            <!-- 选择员工 -->
            <el-form-item label="选择员工 :" prop="staffs">
              <el-select v-model="baseForm.staffs" style="width: 100%" multiple collapse-tags placeholder="请选择群发员工（可多选）" @change="staffsListChange">
              ...
              <div class="filterCus">
                ...
                <el-form-item label="选择群聊 :" prop="chatGroup">
                  <el-select multiple v-model="baseForm.chatGroup" style="width: 100%" placeholder="请选择群聊" @change="chatGroupListChange">
                    <el-option :key="item.id" :label="item.name" :value="item.chatId" v-for="item in chatGroupList"></el-option>
                  </el-select>
                </el-form-item>
      ...
      <div class="group-content">
        ...
        <div class="appendix-list">
          <div class="item marB-24" v-for="(item, index) in appendixList" :key="index">
            ...
            <template v-if="item.appendixType === '图片'">
              <van-uploader v-model="item.picList" :max-count="1" :after-read="afterRead" />
        ...
        <div class="appendix-add-warp">
          ...
          <span class="add-tips" style="margin-left: 24px">（最多可添加9个附件）</span>
        </div>
        <!-- 通知成员 -->
