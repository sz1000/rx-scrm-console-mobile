<template>
  <div class="microCode">
    ...
    <div class="searchInput">
      <input type="text" class="input" v-model="inputValue" placeholder="请输入活码名称" />
        ...
        <div class="cardCode" v-for="(item, index) in liveList" :key="index">
          <div class="operationTop">
            ...
            <div class="editBtn" v-show="type == 2">
              <span @click="editBtn(item)" v-show="alllist.some((item) => item.enName == 'edit')">
                <van-icon name="edit" />
                编辑
              </span>
    ...
    <div class="bottom_model">
          ...
          <div class="content">
            <div class="addForm">
              <el-form ref="form" :model="addForm" label-position="right">
                <el-form-item label="活码名称:" prop="name" :rules="[
                    {
                      required: true,
                      message: '请输入活码名称',
                      trigger: 'blur',
      ...
      <van-action-sheet v-model="showDetail" :title="titleName" :overlay="overlay">
        <div class="content">
