      ...
      <div class="tree-header">
        <div class="header-left">
          ...
          <span class="header-name"
                @click="groupNameList(parent,index)">{{parent.title}}</span>
        </div>
        <!-- <div class="header-r">
            ...
            <div class="tree-header ">
              <div class="header-left child-title">
                ...
                <i class="el-icon-caret-bottom"
                   v-show="child.isOpen"></i>
                <span class="header-name"
                      @click="groupNameList(child,index)">{{child.title}}</span>
              </div>
              <div class="header-r"
                  ...
                  <div class="tree-header ">
                    <div class="header-left three-title">
                      ...
                      <i class="el-icon-caret-bottom"
                         v-show="grandson.isOpen"></i>
                      <span class="header-name"
                            @click="groupNameList(grandson,index)">{{grandson.title}}</span>
                    </div>
                    <div class="header-r"
