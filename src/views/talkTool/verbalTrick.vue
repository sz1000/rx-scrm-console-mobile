                  ...
                  <div v-for="(item, i) in treeData"
                    ...
                    <div class="tree-header">
                      ...
                      <span class="header-mid"
                        ...
                        <span class="gray">({{ item.children.length }})</span></span>
                      <!-- <span
                        class="header-right"
                      ...
                      <div v-if="item.children.length">
                        ...
                        <div v-for="(sub, k) in item.children"
                          ...
                          <div class="tree-header">
                            ...
                            <span class="header-mid"
                                  @click.stop="sub.isOpen = !sub.isOpen">{{ sub.name }}
        ...
        <div>
          <van-collapse v-model="activeName"
            ...
            <van-collapse-item title="列表一"
              ...
              <van-collapse-item title="列表1.1"
                                 name="4">
                <div>3333</div>
              </van-collapse-item>
            </van-collapse-item>
            <van-collapse-item title="列表二"
                               name="2">内容</van-collapse-item>
            <van-collapse-item title="列表3"
