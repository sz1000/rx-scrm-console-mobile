<template>
  <div class="channelConfig">
    ...
    <div class="searchInput">
      <input type="text" class="input" v-model="inputValue" placeholder="请输入渠道名称" />
    ...
    <div class="bottom_model">
      <van-action-sheet v-model="showAdd" :title="titleName" ref="vantWarp" class="vant_sheet">
        <div class="content">
          <div class="addForm">
            <el-form ref="form" :model="addForm" label-position="right">
              <el-form-item label="渠道名称:" prop="name" :rules="[
                ...
                <el-input v-model="addForm.name" placeholder="请输入渠道名称" maxlength="15"
                  show-word-limit></el-input>
              </el-form-item>
              <el-form-item label="欢迎语:" class="textareaInput">
                <el-input type="textarea" v-model="addForm.welText"
                  placeholder="快来设置欢迎语吧~ 设置个性化欢迎语，扫描该员工活码添加的客户，将自动推送该欢迎语" maxlength="200"
                  show-word-limit></el-input>
              </el-form-item>
            </el-form>
          </div>
      ...
      <van-action-sheet v-model="showEdit" :title="titleName" class="vant_sheet">
        <div class="content">
          <div class="addForm">
            <el-form ref="form" :model="editForm" label-position="right">
              <el-form-item label="渠道名称:" prop="name" :rules="[
                ...
                <el-input v-model="editForm.name" placeholder="请输入渠道名称" maxlength="15"
                  show-word-limit></el-input>
              </el-form-item>
              <el-form-item label="欢迎语:" class="textareaInput">
                <el-input type="textarea" v-model="editForm.welText"
                  placeholder="快来设置欢迎语吧~ 设置个性化欢迎语，扫描该员工活码添加的客户，将自动推送该欢迎语" maxlength="200"
                  show-word-limit></el-input>
              </el-form-item>
            </el-form>
