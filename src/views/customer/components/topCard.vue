            ...
            <div class="info_box">
                ...
                <div class="val">
                    <div class="name_box" v-if="customerInfo.name">
                        ...
                        <div class="alt" :class="{'green':customerInfo.customerType == 1}" v-if="Number(customerInfo.customerType) && customerInfo.name.length < 10">{{customerInfo.customerType == 1 ? '@微信' : `@${customerInfo.customerName}`}}</div>
