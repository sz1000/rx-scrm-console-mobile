...
export const ReceiveUser = data => { return http.get(`${customerServiceApi}/clueCustomerFollowUser/receive-user?customerNo=${data.customerNo}&isPublic=${data.isPublic}`)} // 获取接收人信息
